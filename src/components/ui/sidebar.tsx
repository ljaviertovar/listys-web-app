  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-white text-foreground flex h-full w-(--sidebar-width) flex-col border-r",
          className
        )}
        {...props}
      >
  ...
  "ring-sidebar-ring hover:bg-sidebar-active hover:text-sidebar-active-foreground active:bg-sidebar-active active:text-sidebar-active-foreground data-active:bg-sidebar-active data-active:text-sidebar-active-foreground data-open:hover:bg-sidebar-active data-open:hover:text-sidebar-active-foreground gap-2 rounded-lg p-2 text-left text-sm transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! focus-visible:ring-2 data-active:font-medium peer/menu-button flex w-full items-center overflow-hidden outline-hidden disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "bg-background hover:bg-sidebar-active hover:text-sidebar-active-foreground shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:shadow-[0_0_0_1px_hsl(var(--sidebar-active))]",
      },
      size: {
        default: "h-9 text-sm",
        sm: "h-8 text-xs",
